...
def pick_adress_sport_pages() :
    ...
    urls = []
    names = []
    pages_url = ["https://rfen.es/es/posts/news?discipline=97",
                 "https://rfen.es/es/posts/news?page=2&discipline=97",
                 "https://rfen.es/es/posts/news?page=3&discipline=97",
                 "https://rfen.es/es/posts/news?page=4&discipline=97"]
