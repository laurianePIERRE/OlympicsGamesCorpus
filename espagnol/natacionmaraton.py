...
def pick_adress_sport_pages() :
    ...
    urls = []
    names = []
    pages_url = ["https://rfen.es/es/posts/news?discipline=110",
                 "https://rfen.es/es/posts/news?page=2&discipline=110",
                 "https://rfen.es/es/posts/news?page=3&discipline=110",
                 "https://rfen.es/es/posts/news?page=4&discipline=110"]
